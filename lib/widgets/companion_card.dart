...
class _CompanionCardState extends State<CompanionCard> {
  ...
  Future<void> checkGroupStatus() async {
    ...
    final groupUrl =
        'https://sportsapp1-31d70-default-rtdb.firebaseio.com/groups/$groupId.json';
  ...
  Future<void> sendJoinRequest() async {
    ...
    final url = Uri.parse(
      'https://sportsapp1-31d70-default-rtdb.firebaseio.com/groups/$groupId/requests/$userId.json',
    );
