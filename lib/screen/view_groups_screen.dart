...
class _ViewGroupsScreenState extends State<ViewGroupsScreen> {
  ...
  Future<void> fetchGroups() async {
    ...
    final url = Uri.parse(
      "https://sportsapp1-31d70-default-rtdb.firebaseio.com/groups.json",
    );
  ...
  Future<void> updateGroupRequest(
    ...
    final groupRef =
        "https://sportsapp1-31d70-default-rtdb.firebaseio.com/groups/$groupId";
  ...
  Future<Map<String, dynamic>?> fetchUserProfile(String userId) async {
    ...
    final url = Uri.parse(
      "https://sportsapp1-31d70-default-rtdb.firebaseio.com/users/$userId.json",
    );
    final res = await http.get(url);
    if (res.statusCode == 200) {
